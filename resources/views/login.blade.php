        ...
        @csrf
            <label class="input input-bordered flex items-center gap-2">
              ...
              <label class="input input-bordered flex items-center gap-2 mt-4">
                ...
                <input type="password" class="grow" value="password" name="password" required/>
                @error('password')
                        <p class="text-red-500 error">{{ $message }}</p>
                    @enderror
              </label>

                <button class="btn btn-info md mt-6 mx-auto block">Login</button>
        </form>

        <div class="mt-4 text-center">
            <a href="/register" class="text-sm text-blue-500 hover:text-blue-700">Sign up</a>
        </div>
    </div>
</div>
